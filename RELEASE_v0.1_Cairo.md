# Global Time Echoes: 25-Year Temporal Evolution (v0.1 Cairo)
...
- **Orbital Coupling**: Enhanced detection of Earth's orbital velocity correlation (r = -0.864, p < 10⁻¹⁰)
...
- **18.6-Year Lunar Nutation**: Clear detection with R² = 0.640, p < 10⁻⁸
...
- **72 Total Events**: Significant increase from 11 events in original analysis
- **34 Bonferroni-Significant**: Events surviving multiple comparison correction
- **Mass-Scaling Analysis**: No significant correlation with planetary masses (r = -0.156)
...
| **Unique Stations** | 814 (CODE analysis center) |
| **Daily Coverage** | 9,221 days |
...
├── site-code-longspan/      # Paper 2: 25-Year Extension (v0.1)
...
- **[v0.1 (Cairo)](https://github.com/matthewsmawfield/TEP-GNSS/releases/tag/v0.1)** - Paper 2: 25-Year Extension (current)
