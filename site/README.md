...
- **Multi-center consistency**: λ<sub>T</sub> = 3,330–4,549 km primary range with bootstrap validation: 3,685–5,413 km (CODE), 3,021–3,639 km (ESA Final), 3,388–4,140 km (IGS Combined)
...
**Website:** https://mlsmawfield.com/tep/gnss-i/  
