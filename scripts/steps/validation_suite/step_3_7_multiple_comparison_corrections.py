#!/usr/bin/env python3
"""
TEP GNSS Analysis - Step 3.7: Multiple Comparison Corrections
===========================================================

Systematic application of formal multiple comparison corrections to all statistical tests
performed across Steps 2.0-4.5. Implements Bonferroni, False Discovery Rate (FDR), and 
Family-wise Error Rate (FWER) corrections to control Type I error inflation.

Requirements: All previous analysis steps (Steps 2.0-4.5) that generate statistical tests should be completed.
Inputs:
...
Outputs:
  - results/outputs/step_3_7_multiple_comparison_corrections.json (detailed corrections)
  - results/outputs/step_3_7_corrected_significance_summary.json (summary report)
  - results/outputs/step_3_7_correction_impact_analysis.csv (impact data)
  - results/figures/step_3_7_correction_impact_visualization.png
  - results/figures/step_3_7_significance_before_after.png
...
class MultipleComparisonCorrector:
    ...
    def create_visualizations(self, corrections: Dict, summary: Dict):
        ...
        plt.savefig(figures_dir / 'step_3_7_correction_impact_visualization.png', 
        ...
        plt.tight_layout()
        plt.savefig(figures_dir / 'step_3_7_significance_before_after.png', 
                   dpi=300, bbox_inches='tight')
...
def main():
    ...
    print_status("", "INFO")
    print_status("TEP GNSS Analysis Package v0.13 - STEP 3.7: Multiple Comparison Corrections", "TITLE")
    ...
    try:
        ...
        with open(outputs_dir / 'step_3_7_multiple_comparison_corrections.json', 'w') as f:
            json.dump(corrections, f, indent=2)
        
        # Save summary
        with open(outputs_dir / 'step_3_7_corrected_significance_summary.json', 'w') as f:
        ...
        df.to_csv(outputs_dir / 'step_3_7_correction_impact_analysis.csv', index=False)
