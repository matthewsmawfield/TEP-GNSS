...
def extract_real_tep_coherence_time_series() -> pd.DataFrame:
    ...
    for center in centers:
        ...
        pair_files = glob.glob(str(ROOT / f"results/tmp/step_2_0_pairs_{center}_*.csv"))
...
def main():
    ...
    try:
        ...
        # Save results
        output_file = ROOT / "results/outputs/step_3_5_realistic_ionospheric_validation.json"
