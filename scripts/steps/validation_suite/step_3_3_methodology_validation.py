...
class MethodologyValidator:
    ...
    def run_enhanced_real_data_zero_lag_test(self, analysis_center: str = 'code', max_files: int = 50) -> Dict:
        ...
        coords_file = Path(__file__).resolve().parents[2] / "data/coordinates/step_1_1_station_coords_global.csv"
        coords_df = pd.read_csv(coords_file)
...
def main():
    ...
    try:
        ...
        if 'validation_summary' in validation_results:
            ...
            print_status("", "INFO")
            print_status("STEP 3.3 VALIDATION SUMMARY FOR TEP-GNSS PIPELINE", "TITLE")
            print_status("", "INFO")
