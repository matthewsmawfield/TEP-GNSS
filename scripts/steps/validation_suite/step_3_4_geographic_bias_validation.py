...
def load_existing_data():
    ...
    if not coords_file.exists():
        coords_file = ROOT / "scripts/data/coordinates/step_1_1_station_coords_global.csv"
    ...
    for ac in ['code', 'esa_final', 'igs_combined']:
        results_file = ROOT / f"results/outputs/step_2_0_correlation_{ac}.json"
    ...
    pair_files = list((ROOT / "results/tmp").glob("step_2_0_pairs_code_*.csv"))
    sample_pairs = []
...
def main():
    ...
    # Save results
    output_file = ROOT / "results/outputs/step_3_4_geographic_bias_validation.json"
