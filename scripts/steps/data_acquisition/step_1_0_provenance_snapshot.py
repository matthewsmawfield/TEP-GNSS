...
def main():
    print_status("TEP GNSS Analysis Package v0.13 - STEP 1.0: Provenance Documentation", "TITLE")
    ...
    snapshot = {
        ...
        "processed_files": [list_dir(ROOT / 'data' / 'coordinates', 'step_1_1_station_coords_global.csv')], # Added output from Step 1.1
    ...
    with open(out_dir / 'step_1_0_provenance_snapshot.json', 'w') as f:
        json.dump(snapshot, f, indent=2)
    print_status(f"Successfully wrote provenance snapshot to {out_dir / 'step_1_0_provenance_snapshot.json'}", "SUCCESS")
