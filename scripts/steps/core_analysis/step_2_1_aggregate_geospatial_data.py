#!/usr/bin/env python3
"""
TEP GNSS Analysis - STEP 2.1: Geospatial Data Processing
======================================================

Processes correlation analysis output from Step 2.0 and enriches station-pair
...
Outputs:
  - `data/processed/step_2_1_geospatial_{ac}.csv`
Next: Step 2.2 (Geospatial Temporal Analysis)

Algorithm Overview:
1.  Scan the `results/tmp/` directory for all step_2_0_pairs_*.csv files
    generated by Step 2.0.
...
def main():
    ...
    print_status("TEP GNSS Analysis Package v0.13 - STEP 4: Geospatial Data Processing", "TITLE")
    ...
    if not pair_data_dir.exists():
        ...
        print_status("Please run Step 2.0 with TEP_WRITE_PAIR_LEVEL=1 to generate the required files.", "ERROR")
        return False

    all_pair_files = glob(str(pair_data_dir / "step_2_0_pairs_*.csv"))
