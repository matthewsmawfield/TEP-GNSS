...
def export_null_test_results(root_dir):
    ...
    for ac in ['code', 'igs_combined', 'esa_final']:
        null_results_file = root_dir / f'results/outputs/step_3_2_null_tests_{ac}.json'
...
def main():
    ...
    print_status("TEP GNSS Analysis Package v0.13 - STEP 4.1: Visualization", "TITLE")
    print("="*80)
    ...
    # Check prerequisites
    step_2_0_complete = (root_dir / 'logs/step_2_0_correlation_analysis.json').exists()
    if not step_2_0_complete:
        print_status("Step 2.0 (Core Analysis) must be completed before running Step 4.1 (Visualization)", "ERROR")
        return False
