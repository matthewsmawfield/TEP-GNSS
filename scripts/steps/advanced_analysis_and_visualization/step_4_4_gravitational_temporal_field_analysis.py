...
def extract_real_daily_tep_coherence_data() -> pd.DataFrame:
    ...
    for center in centers:
        ...
        pair_files = glob.glob(f'/Users/matthewsmawfield/www/TEP-GNSS/results/tmp/step_2_0_pairs_{center}_*.csv')
...
def create_comprehensive_visualization(combined_df: pd.DataFrame, analysis_results: Dict) -> str:
    ...
    # Save the figure
    output_path = '/Users/matthewsmawfield/www/TEP-GNSS/results/figures/step_4_4_comprehensive_gravitational_temporal_analysis.png'
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.close()
    
    # Copy to site figures folder for manuscript
    import shutil
    site_path = '/Users/matthewsmawfield/www/TEP-GNSS/site/figures/step_4_4_comprehensive_gravitational_temporal_analysis.png'
...
def main():
    ...
    """
    print_status("TEP GNSS Analysis Package v0.13 - STEP 4.4: Comprehensive Gravitational-Temporal Field Correlation Analysis", "TITLE")
    print()
    ...
    # Save results
    results_path = '/Users/matthewsmawfield/www/TEP-GNSS/results/outputs/step_4_4_gravitational_temporal_field_analysis.json'
    with open(results_path, 'w') as f:
        json.dump(analysis_results, f, indent=2, default=str)
    
    data_path = '/Users/matthewsmawfield/www/TEP-GNSS/data/processed/step_4_4_comprehensive_gravitational_temporal_data.csv'
    combined_df.to_csv(data_path, index=False)

    # Export WebGL-ready dataset for Step 17 visualization (no fallbacks)
    export_dir = Path('/Users/matthewsmawfield/www/TEP-GNSS/site/data/step_4_4')
