...
Environment Variables (v0.4 defaults for published methodology):
  
  CORE ANALYSIS:
  - TEP_USE_PHASE_BAND: Use band-limited phase analysis (default: 1, v0.4 method)
...
def compute_cross_power_plateau(series1: np.ndarray, series2: np.ndarray, fs: float, 
    ...
    if use_real_coherency:
        ...
        use_phase_band = os.getenv('TEP_USE_PHASE_BAND', '1') == '1'  # Default to v0.4 method
        if use_phase_band:
