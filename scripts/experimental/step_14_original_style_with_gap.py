#!/usr/bin/env python3
"""
Step 14 Original Style with Gap
...
def main():
    print("=" * 80)
    print("STEP 14: ORIGINAL STYLE WITH GAP FOR BAD PERIOD")
    print("=" * 80)
    ...
    # Advanced pattern analysis with smoothing (like original)
    window_size = min(31, len(clean_df) // 10)
    ...
    # Save the figure
    output_path = '/Users/matthewsmawfield/www/TEP-GNSS/figures/step_14_original_style_with_gap_gravitational_temporal_analysis.png'
    ...
    import shutil
    site_path = '/Users/matthewsmawfield/www/TEP-GNSS/site/figures/step_14_original_style_with_gap_gravitational_temporal_analysis.png'
    ...
    results_path = '/Users/matthewsmawfield/www/TEP-GNSS/results/experimental/step_14_original_style_with_gap_results.json'
