...
### v0.5 Configuration (Published Method Defaults)

**Core Analysis Settings:**
| Variable | Default | Description |
|----------|---------|-------------|
| `TEP_USE_PHASE_BAND` | 1 | Band-limited phase analysis (v0.5 method) |
...
**Simple Command for v0.5 Results:**
```bash
python scripts/steps/step_3_tep_correlation_analysis.py
```
...
- Full analysis report (PDF): `Smawfield_2025_GlobalTimeEchoes_Preprint_v0.5_Jaipur.pdf`
