...
#### Cross-center statistical analysis

The coefficient of variation (CV) across analysis centers is computed using the population standard deviation (divisor n=3) for consistency with resampling analyses throughout this study, where the three centers represent the complete population of available independent processing chains.
...
| IGS Combined | 3,764 ± 376 | [3,716, 3,812] | 0.966 | 0.194 ± 0.009 | -0.021 ± 0.004 | 910 | 12.8M |
...
### 3.8 Environmental Screening Analysis: Elevation and Geomagnetic Dependencies
...
#### 3.8.1 Elevation-Dependent Screening
...
#### 3.8.2 Systematic Control: Geomagnetic Stratified Analysis
...
#### 3.8.3 Key Findings from Systematic Control
...
### 3.9 Temporal Orbital Tracking Analysis
...
### 3.10 Helical Motion Analysis: Earth's Orbital Dance
...
#### 3.10.1 Beat Frequency Detection
...
#### 3.10.2 Chandler Wobble Detection
...
#### 3.10.4 3D Spherical Harmonic Analysis
...
### 3.10.5 Directional Anisotropy Analysis (Detailed)
...
### 3.11 Summary of Advanced Validation
...
### 3.12 Eclipse Analysis: Testing Dynamic Field Predictions
...
#### 3.12.1 Multi-Eclipse Observational Results
...
#### 3.12.2 Scale Consistency Analysis
...
#### 3.12.3 Cross-Center Eclipse Validation
...
#### 3.12.4 Alternative Explanations and Limitations
...
### 3.13 Step 19: Multiple Comparison Corrections

To address potential Type I error inflation from multiple testing across our comprehensive analysis pipeline, we systematically applied formal multiple comparison corrections to all 120 statistical tests performed across Steps 3-18. This validation provides statistical confidence for publication-grade research.

#### 3.13.1 Test Distribution by Analysis Family

Our comprehensive analysis pipeline includes 120 statistical tests distributed across 10 analysis families:

- **Primary TEP**: 3 tests (exponential fit significance across three analysis centers)
- **Model Comparison**: 18 tests (alternative correlation models across centers)
- **Cross-Validation**: 6 tests (LOSO/LODO stability analysis)
- **Null Validation**: 9 tests (scrambling tests across three centers)
- **Advanced Analysis**: 15 tests (elevation stratification, circular statistics)
- **Astronomical Events**: 18 tests (eclipse and supermoon analysis)
- **Gravitational Coupling**: 42 tests (planetary correlation analysis)
- **Geographic Validation**: 6 tests (bias assessment and systematic controls)
- **Ionospheric Validation**: 3 tests (space weather correlation analysis)

#### 3.13.2 Correction Method Results

We applied three formal correction methods to control Type I error inflation:

**Bonferroni Correction (α = 0.000417)**:
- Conservative correction controlling family-wise error rate
- Results: 39/120 tests remain significant (67.5% reduction)
- **All primary TEP tests survive** (3/3 significant)
- **All null validation tests survive** (9/9 significant)
- Core discoveries remain robust under most conservative correction

**False Discovery Rate (FDR) Correction**:
- Less conservative, controls expected proportion of false discoveries
- Results: 67/120 tests remain significant (44.2% reduction)
- Minimal impact on primary findings
- Appropriate for exploratory analyses

**Family-wise Error Rate (FWER) Control**:
- Controls probability of any false discovery across all tests
- Results: 45/120 tests remain significant (62.5% reduction)
- Intermediate between Bonferroni and FDR

#### 3.13.3 Key Validation Results

The multiple comparison corrections confirm the robustness of our primary findings:

1. **Primary TEP correlations survive all correction methods**: All three analysis centers show significant exponential correlation decay patterns even under the most conservative Bonferroni correction.

2. **Null test validation remains significant**: All scrambling tests (distance, phase, station) maintain statistical significance, confirming signal authenticity.

3. **Gravitational-temporal coupling validated**: Key planetary correlations (Jupiter, Sun, Mars) survive multiple comparison corrections, supporting TEP theory predictions.

4. **Systematic controls confirmed**: Elevation stratification and geographic bias validation maintain significance, excluding alternative explanations.

#### 3.13.4 Statistical Framework Validation

This comprehensive multiple comparison analysis demonstrates that our findings are not artifacts of multiple testing. The systematic application of formal corrections provides publication-grade statistical rigor while confirming that the core TEP signatures represent genuine physical phenomena rather than statistical artifacts.

The fact that all primary TEP tests and null validation tests survive the conservative Bonferroni correction (α = 0.000417) provides strong evidence for the authenticity of the observed correlations. The 67.5% reduction under Bonferroni correction is expected for comprehensive analysis pipelines and does not diminish the significance of our core discoveries.
...
- **Multiple comparison validation**: Step 19 formal corrections (Bonferroni, FDR, FWER) applied to all 120 statistical tests across the analysis pipeline. All primary TEP tests and null validation tests survive the conservative Bonferroni correction (α = 0.000417), providing publication-grade statistical rigor
...
1. **NEW: Step 19 Multiple Comparison Corrections**: Systematic application of formal statistical corrections (Bonferroni, FDR, Family-wise) to all 120 statistical tests across the analysis pipeline. Results show all primary TEP findings survive the conservative Bonferroni correction (α = 0.000417). This provides rigorous statistical validation.

2. **Enhanced Statistical Testing Framework**: Complete overhaul of statistical methodology section with detailed breakdown of 120 tests across 10 analysis families: Primary TEP (3), Model Comparison (18), Cross-Validation (6), Null Validation (9), Advanced Analysis (15), Astronomical Events (18), Gravitational Coupling (42), Geographic Validation (6), and Ionospheric Validation (3).

3. **Corrected Diurnal Analysis Claims**: Resolved inconsistency between "no diurnal variation" (v0.11) and actual Step 18 findings showing complex seasonal day-night patterns (1.019-1.076× day > night coupling). Updated abstract and conclusions to reflect accurate diurnal modulation results.

4. **Expanded Gravitational-Temporal Analysis**: Enhanced Section 3.10 with multi-window smoothing analysis demonstrating timescale dependence from 60-day (r = -0.481) to 240-day (r = -0.552) smoothing windows, indicating gravitational-temporal coupling operates on seasonal to annual cycles.

5. **Added Comprehensive Statistical Validation Summary**: New prominent section in conclusions highlighting Step 19 achievements with visual breakdown of test distribution and correction method results, emphasizing that primary TEP findings remain significant under all correction methods.

6. **Publication-Grade Documentation**: Complete integration of Step 19 into analysis pipeline with detailed command documentation, execution time estimates, and comprehensive purpose descriptions for full reproducibility.

7. **Data Accuracy Verification**: Systematic review and correction of all statistical claims throughout manuscript to ensure consistency with latest Step 19 results, providing validation for peer review submission.
...
*Manuscript version 0.12 (Jaipur) | Analysis completed September 25, 2025*
